...
from nightpanel.models import Profile, Shortcut
...
class ProfileService:
    ...
    def _get_profiles_dir(self) -> Path:
        ...
        config_dir = Path(GLib.get_user_config_dir()) / "nightpanel" / "profiles"
    ...
    def _get_presets_dir(self) -> Path:
        ...
        for data_dir in data_dirs:
            preset_dir = Path(data_dir) / "nightpanel" / "presets"
    ...
    def _get_active_profile_name(self) -> str | None:
        ...
        settings = Gio.Settings.new("io.github.gregfelice.Nightpanel")
    ...
    def capture_current_state(self, name: str, description: str = "") -> Profile:
        ...
        from nightpanel.models import Profile
