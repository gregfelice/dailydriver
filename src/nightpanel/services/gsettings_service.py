...
This module is deprecated. Use dailydriver.services.backends instead:
    ...
    from nightpanel.services.backends import get_shortcuts_backend
    backend = get_shortcuts_backend()

Or for GNOME-specific code:

    from nightpanel.services.backends import GnomeShortcutsBackend
...
from nightpanel.services.backends.gnome import (
    CATEGORIES,
    KEY_CATEGORIES,
    SHORTCUT_SCHEMAS,
