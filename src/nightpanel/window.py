...
from nightpanel.models import Shortcut, ShortcutCategory
...
from nightpanel.services.keyboard_config_service import CapsLockBehavior, KeyboardConfigService
from nightpanel.services.nightpanel_orchestrator import NightpanelOrchestrator
from nightpanel.services.theme_service import ThemeService
from nightpanel.services.tiling_service import TilingService
from nightpanel.views.appearance_view import AppearanceView
from nightpanel.views.cheatsheet import CheatSheetView
from nightpanel.views.keyboard_view import KeyboardView
from nightpanel.views.preset_selector import PresetSelector
from nightpanel.views.profiles_view import ProfilesView
from nightpanel.views.setup_view import SetupView
from nightpanel.views.shortcut_editor import ShortcutEditorDialog
from nightpanel.views.shortcut_list import ShortcutListView
...
class DailyDriverWindow(Adw.ApplicationWindow):
    ...
    def _get_app_settings(self) -> Gio.Settings | None:
        ...
        schema_id = "io.github.gregfelice.Nightpanel"
    ...
    def _on_layout_toggled(self, radio: Gtk.CheckButton, key: str) -> None:
        ...
        from nightpanel.models import FnMode, MacKeyboardConfig
        from nightpanel.services.hid_apple_service import HidAppleService
    ...
    def _on_load_modifications(self, button: Gtk.Button) -> None:
        ...
        profiles_dir = Path(GLib.get_user_config_dir()) / "nightpanel" / "profiles"
